...
$ROOT/ndc-test replay --endpoint http://localhost:8080 --snapshots-dir $ROOT/test/testdata/01-setup
$ROOT/ndc-test replay --endpoint http://localhost:8080 --snapshots-dir $ROOT/test/testdata/02-cleanup
